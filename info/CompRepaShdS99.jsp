							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
									...
									<tr>
										...
										<td colspan="3"><e:eshowfield name="khaddr"   /> </td>
										<td width="100px" class="Tab_title">所属区域</td>
										<td width="140px"><e:eselect name="area"  asName="ComputerAreaTpye"   emptyOption="true" disabled="true" /> </td>
										<td width="100px" class="Tab_title">维修结果</td>
										<td width="140px"><e:eselect name="wxjg" asName="ComputerRepairResult"  emptyOption="true" disabled="true" />
										</td>
									</tr>
