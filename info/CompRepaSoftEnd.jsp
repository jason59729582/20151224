	    	      ...
	    	      <e:etab title="时间情况" tabType="T1" >
							...
							<e:etab title="软件情况" tabType="T1">
								...
								<colgroup> 
									...
									<tr height="46">
										<td  class="Tab_title">维护报告</td>
										<td colspan="7"><e:etextfield name="wxMem" maxSize="128"  nullAble='true' />
										</td>
							...
							<e:etab title="结算费用" tabType="T1" >
								<table width="960px"    >
									...
									<tr id="expenseBar2" style="display:">
										...
										<td width="300px"><e:enumbfield name="wxJf"
												nullAble="true" decimalSize="2" title="单位：元" value="0.00"
												intSize="4" />
										</td>
									</tr>
