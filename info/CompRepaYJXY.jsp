							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
									...
									<tr>
										...
										<td ><e:eselect name="type" asName="ComputerRepairType2" 	 emptyOption="false" /> 	
										</td>
									</tr>
