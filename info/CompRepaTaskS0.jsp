...
function submitBefore(){
 	    document.all.MainForm.step.value = "S6";//派工完成，即进入修复状态
		return true;
}
...
<body>
	<e:form action="CompRepaMana" id="MainForm"
		...
		<e:hidden name='department' />
			   ...
			   <e:hidden id='source' name="source" />
	   <e:hidden id='weixinId' name="weixinId" />
