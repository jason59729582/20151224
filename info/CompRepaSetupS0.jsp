...
function submitBefore(){
 	    document.all.MainForm.step.value = "S1";//派工完成，即进入修复状态
		return true;
}
							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
									...
									<tr>
										...
										<td colspan="3"><e:etextfield name="khname" maxSize="64" nullAble='true' /></td>
										<td class="Tab_title">使用人</td>
										<td >  	<e:epopfield name="syr"  ondblclick="PopSyrSelect(this)"  nullAble='true' /></td>
