						...
						<e:etab title="结算费用" tabType="T1" >
								<table width="960px"    >
									...
									<tr id="expenseBar2" style="display:">
										...
										<td  class="Tab_title">实际采购额</td>
										<td colspan="3" ><e:eshowfield name="sjsf" /></td>
										<td  class="Tab_title">结算积分</td>
										<td colspan="3"><e:enumbfield name="wxJf" 	nullAble="true" decimalSize="2" title="单位：元" value="0.00"  intSize="4" /> </td>
									</tr>
