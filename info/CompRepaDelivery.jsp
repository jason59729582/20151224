...
<tr>
	    	      ...
	    	      <e:etab title="时间情况" tabType="T1" >
							...
							<e:etab title="外送情况" tabType="T1"  >
								<table width="960px">
								<tr>
								<td width="100px" class="Tab_title">外送产品</td>
										<td colspan="3"><e:egroupselect name="product"    emptyOption="true"  initFunction="initrProductSelect" />	</td>
							...
							<e:etab title="服务费用" tabType="T1" >
								<table width="960px"    >
									...
									<tr id="expenseBar1" style="display:" >
										...
										<td width="100px" class="Tab_title">服务报价</td>
