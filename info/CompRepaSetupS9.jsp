							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
									...
									<tr>
										...
										<td ><e:eselect name='type' asName="ComputerRepairType2" 			   emptyOption="false" /> 			</td>
									</tr>
	    	      ...
	    	      <e:etab title="时间情况" tabType="T1" >
								...
								<tr>
  									...
  									<tr>									
										...
										<td  colspan="3"><e:eshowfield name="xfTime" /></td>
										<td class="Tab_title">结算时间</td>
										<td colspan="3"><e:eshowfield name="jsTime" /></td>
								     </tr>
							...
							<e:etab title="故障情况" tabType="T1" >
								<table width="960px">
									...
									<tr height="46">
										...
										<td colspan="7"><e:etextfield name="gzMem" maxSize="128"
												nullAble='true' />
										</td>
									</tr>
							...
							<e:etab title="安装报价" tabType="T1" >
								...
								<colgroup> 
									...
									<tr id="expenseBar1" style="display:" >
										...
										<td ><e:eshowfield name="smf" /></td>
										<td  class="Tab_title">材料费</td>
										<td ><e:eshowfield name="clf" /></td>
										<td  class="Tab_title">服务费</td>
										<td ><e:eshowfield name="wxf" /></td>
										<td  class="Tab_title">合计报价</td>
										<td ><e:eshowfield name="clintPrice" /></td>
									</tr>
									</table>
									</e:etab>
