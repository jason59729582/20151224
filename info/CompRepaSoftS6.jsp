...
function submitBefore(){
 	    document.all.MainForm.step.value = "S9";
        return true;
}
							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
										<tr>
											...
											<td width="140px"><e:eselect name='RepairType' asName="ComputerType"  	   emptyOption="false" /></td>														   <td width="100px" class="Tab_title">上级单号</td>
									...
									<tr>
										<td width="100px" class="Tab_title">服务单号</td>
										<td width="140px"><e:eshowfield name="wxdh" title="服务单号" />	</td>
									...
									<tr>
										...
										<td width="100px" class="Tab_title">服务级别</td>
									...
									<tr>
										...
										<td width="100px" class="Tab_title">服务状态</td>
									...
									<tr>
										...
										<td width="100px" class="Tab_title">服务结果</td>
									...
									<tr>
										...
										<td width="100px" class="Tab_title">服务类型</td>
							...
							<br>							
								...
								<table width="960px"    >
									...
									<tr id="expenseBar2" style="display:">
										...
										<td colspan="3">
										<e:eselect name="sfType" asName="paymentType"
												  emptyOption="false" />
									...
									<tr id="expenseBar3" style="display:" >
										...
										<td colspan="3"><e:etextfield name="sfBillcode"
												maxSize="32" title='来自速达的销售开单' nullAble='false' />
										</td>
