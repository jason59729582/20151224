...
function PopSyrSelect(obj){
   ...
   alert(document.all.MainForm.khcode.value);
      ...
      if(id=='MapFrame'){
   	     	...
   	     	if(document.MainForm.wxdh.value!=null&&document.MainForm.wxdh.value!=''&&document.MainForm.wxdh.value!='0'){
		            ...
		            if(param!=null&&param!=""){
                      ...
                      alert(document.MainForm.glId.value);
...
function do_qybh_change(){
 ...
 function do_Report(){
		...
		var list = new ListXML(); 	
		 ...
		 var billType =  document.all.MainForm.billType.value;
		var ReportName = "ComputerRepair_"+CompDepart+"_"+billType+".rpt";
		alert(ReportName);
...
<body>
	<e:form action="CompRepaMana" id="MainForm"
		...
		<e:hidden id='RepairType' name="RepairType" />
		...
		<table width="100%" height="100%" border="0">
			<tr height="100%" valign="top">
				<td align="center"><e:etabpanel id="TabPanle"
						tabTitles="基础信息,相关文件,地理位置,档案维护,相关人员"
						tabIds="tab1,DocFrame,MapFrame,DocModi,empFrame"
							...
							<e:etab title="接单情况" tabType="T1" >
								<table width="960px">
										<tr>
											...
											<td width="140px"><e:eselect name='billType' asName="ComputerRepairbillType" 	 value="01"		   emptyOption="false" /></td>									
	    	      ...
	    	      <e:etab title="时间情况" tabType="T1" >
								<table width="960px">
                      	        <tr>
										...
										<td width="140px"><e:eshowfield name="xfTime" />
										</td>
										<td width="100px" class="Tab_title">质检时间</td>
										<td width="140px"><e:eshowfield name="QualityTime" /></td>
							...
							<e:etab title="维修费用" tabType="T1" >
								<table width="960px">
									...
									<tr>
										...
										<td width="140px"><e:etextfield name="sfType"
